...
const Index = () => {
    ...
    useEffect(() => {
        setTimeout(() => {
            ...
            axios.get(`https://nodeasaltask-production.up.railway.app/api/blogs/by/${id}`)
                .then((res) => {
            ...
            <div className='w-full h-auto pb-10'>
                ...
                <div className='w-83 m-auto flex h-fit  pl-16 mt-8'>
                    ...
                    <div className="w-1/4 h-[350px] pl-6  bg-white rounded-lg shadow dark:border  dark:bg-gray-800 dark:border-gray-700 flex-col flex justify-between pb-10">
                        ...
                        <h1 className='text-white font-bold'>{userInfo.firstName} {userInfo.lastName}</h1>
                        <div className=' w-full flex flex-col'>
                            ...
                            <p className='flex w-[60%] text-sm  mt-3 items-center text-gray-500'>
                                ...
                                {userInfo.city} - {userInfo.officeAddress}
                            </p>
