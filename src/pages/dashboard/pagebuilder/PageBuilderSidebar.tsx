...
const PageBuilderSidebar = () => {
    return (
        <aside className='absolute bg-white flex-col h-screen  flex  top-0 left-0 z-40 w-[60px] h-screen transition-transform -translate-xfull shadow-lg pt-5'>
            <p className='flex justify-center items-center mb-6  w-full'>
                <svg className='w-9 h-9 text-zinc-900' aria-hidden="true" fill="currentColor" stroke-width="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            </p>          <p className='flex justify-center items-center mb-6  w-full'>
                <svg className='w-7 h-7 text-zinc-900' aria-hidden="true" fill="currentColor" stroke-width="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
