      ...
      <div className='shadow-md w-full fixed top-0 left-0'>
          <div className='md:flex items-center justify-between bg-white py-5 md:px-10 px-7 '>
            ...
            <div className='md:flex items-center justify-between w-1/6'>
              <a className='text-l text-gray-800 hover:text-sky-600 duration-500  underline cursor-pointer'>Log in</a>
              <button className="bg-blue-700	hover:bg-sky-600	duration-500 text-white font-semibold hover:text-white py-2 px-4 border border-blue-500 hover:border-transparent rounded">
                Getting Started
              </button>
            </div>
          </div>
      </div>
      <div className='w-full h-2/3 flex items-center justify-around flex-col'>
          ...
          <button className="bg-white	hover:bg-sky-600	duration-500 text-black h-16 w-1/6 hover:text-white py-2  rounded-full">
                Getting Started
              </button>
      </div>
   </div>
